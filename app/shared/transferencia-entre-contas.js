(function () {
  ...
  // Data: nasce preenchida com hoje, mas o usuário pode alterar — mesmo
  // componente único de calendário do sistema (ver date-picker.js).
  ...
  // Bancárias), com o rótulo já usado no restante do sistema pra este
  // catálogo ("<banco> · <descrição>", ver novo-lancamento-caixa.js).
