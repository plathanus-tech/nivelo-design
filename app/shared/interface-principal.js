(function () {
  ...
  var NAV_DESTINATIONS = { dashboard: 'dashboard.html', 'cadastro-pessoas': 'cadastros.html', 'cadastro-produtos': 'produtos.html', estoque: 'estoque.html', 'config-fazenda': 'fazendas.html', 'config-conta-bancaria': 'contas-bancarias.html', 'config-conta-financeira': 'contas-financeiras.html', 'config-categorias': 'categorias-financeiras.html', 'fiscal-natureza': 'naturezas-operacao.html', 'fiscal-certificado': 'certificado-digital.html', 'vendas-nota-fiscal': 'notas-fiscais.html', 'financeiro-caixa': 'caixa.html', 'financeiro-pagar': 'contas-a-pagar.html', 'financeiro-receber': 'contas-a-receber.html', 'financeiro-relatorios': 'relatorios.html', 'canal-ideias': 'canal-ideias.html', 'assistente-numeros': 'meus-numeros-whatsapp.html', 'assistente-nova-conversa': 'nova-conversa.html', 'fiscal-manifesto': 'manifestos.html' };
