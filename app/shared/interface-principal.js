(function () {
  ...
  var NAV_DESTINATIONS = { dashboard: 'dashboard.html', 'caderno-campo': 'caderno-de-campo.html', 'cadastro-pessoas': 'cadastros.html', 'cadastro-produtos': 'produtos-v2.html', estoque: 'estoque.html', 'config-fazenda': 'fazendas.html', 'config-conta-bancaria': 'contas-bancarias.html', 'config-conta-financeira': 'contas-financeiras.html', 'config-categorias': 'categorias-financeiras.html', 'config-unidade-medida': 'unidades-medida.html', 'fiscal-natureza': 'naturezas-operacao.html', 'fiscal-certificado': 'certificado-digital.html', 'fiscal-nota-entrada': 'fiscal.html','vendas-pedidos': 'pedidos-de-venda.html', 'vendas-nota-fiscal': 'notas-fiscais-v2.html', 'financeiro-caixa': 'caixa.html', 'financeiro-pagar': 'contas-a-pagar.html', 'financeiro-receber': 'contas-a-receber-v2.html', 'financeiro-relatorios': 'relatorios-v2.html', 'canal-ideias': 'canal-ideias.html', 'assistente-numeros': 'meus-numeros-whatsapp.html', 'assistente-nova-conversa': 'nova-conversa.html', 'fiscal-manifesto': 'manifestos.html', videos: 'videos.html', 'config-minha-conta': 'minha-conta.html' };
