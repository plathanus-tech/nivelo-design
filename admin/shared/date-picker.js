...
(function () {
  ...
  function positionPopover(trigger, popover) {
    ...
    // Abre pra baixo por padrão; se não houver espaço suficiente na viewport
    // (campo perto do fim da página, sem scroll que revele um elemento
    // `position:fixed`), abre pra cima do trigger em vez disso — nunca muda
    // tamanho/estilo do calendário, só o ponto de ancoragem vertical.
    var height = popover.getBoundingClientRect().height;
