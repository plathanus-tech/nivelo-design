...
const palettes = [
  { name: 'Brand Blue — Principal (RGB 23, 82, 176)', prefix: '--color-brand',  steps: ['50','100','200','300','400','500','600','700','800','900','950'] },
  { name: 'Accent Gold — Uso pontual (RGB 239, 203, 52)', prefix: '--color-accent', steps: ['50','100','200','300','400','500','600','700','800','900','950'] },
...
function PaletteRow({ name, prefix, steps }: { name: string; prefix: string; steps: string[] }) {
  return (
    <div style={{ marginBottom: 28 }}>
      <h3 style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', fontSize: 14, fontWeight: 600, marginBottom: 10, color: 'var(--color-text-primary)' }}>{name}</h3>
...
const aliasGroups: TokenGroup[] = [
  ...
  },
  {
    ...
    tokens: [
      { name: 'action-secondary',         token: '--color-action-secondary',         light: 'Brand/100', dark: 'Brand/900', description: 'Padrão' },
      { name: 'action-secondary-hover',   token: '--color-action-secondary-hover',   light: 'Brand/200', dark: 'Brand/800', description: 'Hover' },
      { name: 'action-secondary-pressed', token: '--color-action-secondary-pressed', light: 'Brand/300', dark: 'Brand/700', description: 'Pressed' },
    ],
  },
  {
    label: 'Action — Accent (uso pontual)',
    tokens: [
      { name: 'action-accent',         token: '--color-action-accent',         light: 'Accent/400', dark: 'Accent/400', description: 'Dourado — apenas destaques' },
      { name: 'action-accent-hover',   token: '--color-action-accent-hover',   light: 'Accent/500', dark: 'Accent/300', description: 'Hover' },
      { name: 'action-accent-pressed', token: '--color-action-accent-pressed', light: 'Accent/600', dark: 'Accent/200', description: 'Pressed' },
    ],
  },
  {
...
const GlobalColorsStory = () => (
  <div style={{ padding: 32, maxWidth: 900 }}>
    <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: 24, fontWeight: 500, marginBottom: 8, color: 'var(--color-text-primary)' }}>Global Tokens — Paletas</h2>
    <p style={{ fontFamily: 'var(--font-body)', fontWeight: 300, fontSize: 14, color: 'var(--color-text-secondary)', marginBottom: 40 }}>
...
const AliasTokensStory = () => (
  <div style={{ padding: 32, maxWidth: 1100, fontFamily: 'Helvetica Neue, Arial, sans-serif' }}>
    <h2 style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', fontSize: 24, fontWeight: 600, marginBottom: 8, color: 'var(--color-text-primary)' }}>Alias Tokens — Cores</h2>
